...
const urls = {
    ...
    physical: {
        authorize: 'https://api.home-connect.com/security/oauth/authorize',
        token: 'https://api.home-connect.com/security/oauth/token',
...
function refreshToken(clientSecret, refreshToken) {
    return new Promise((resolve, reject) => {
        request.post({
            ...
            url: isSimulated ? urls.simulation.token : urls.physical.token,
...
function getAuthorizationCode(clientId) {
    return new Promise((resolve, reject) => {
        ...
        let url = isSimulated ? urls.simulation.authorize : urls.physical.authorize;
